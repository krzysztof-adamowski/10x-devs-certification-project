<!-- Project rules — preserved outside the 10x-cli managed region -->

Product code lives in `TenExCards/`. Read @TenExCards/AGENTS.md before touching it.
Decision chain: `context/foundation/prd.md`, `context/foundation/tech-stack.md`.
